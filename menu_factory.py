...
class MenuFactory:
    ...
    TA_PROCESS = "TA.process"
    TA_BROWSE = "TA.browse"
    TAOPCOST_TITLE = "TAOpcost.title"
    TAOPCOST_FEATURES = "TAOpcost.features"
    TAOPCOST_OTHER = "TAOpcost.other"
    TAOPCOST_ABACUS_OPPORTUNITY_COST = "TAOpcost.abacus_opportunity_cost"
    TAOPCOST_ABACUS_PROJECT_FILE = "TAOpcost.abacus_project_file"
    TAOPCOST_ABACUS_BROWSE = "TAOpcost.abacus_browse"
    TAOPCOST_ABACUS_PROCESS = "TAOpcost.abacus_process"
    ...
    TAOPCOST_OPCOST_DATABASE = "TAOpcost.opcost_database"
    TAOPCOST_OPCOST_REPORT = "TAOpcost.opcost_report"
    ...
    TAREGECO_OTHER_PARAMETERS = "TARegeco.other_parameters"
    TAREGECO_FEATURES = "TARegeco.features"
    TAREGECO_DESCRIPTIVE_ANALYSIS_OF_RE = "TARegeco.descriptive_analysis_of_re"
    TAREGECO_RE_SCENARIO_IMPACT = "TARegeco.re_scenario_impact"
    TAREGECO_LUC_IMPACT = "TARegeco.luc_impact"
    TAREGECO_DESCRIPTIVE_ANALYSIS = "TARegeco.descriptive_analysis"
    TAREGECO_INITIALIZE = "TARegeco.initialize"
    TAREGECO_INITIAL_INPUT = "TARegeco.initial_input"
    TAREGECO_NUMBER_OF_SECTOR = "TARegeco.number_of_sector"
    TAREGECO_IO_TABLE = "TARegeco.io_table"
    TAREGECO_NEXT = "TARegeco.next"
    TAREGECO_SINGLE_PERIOD = "TARegeco.single_period"
    ...
    TAREGECO_VALUE_ADDED_MATRIX = "TARegeco.value_added_matrix"
    TAREGECO_VALUE_ADDED_COMPONENT = "TARegeco.value_added_component"
    TAREGECO_FINAL_CONSUMPTION_MATRIX = "TARegeco.final_consumption_matrix"
    TAREGECO_FINAL_CONSUMPTION_COMPONENT = "TARegeco.final_consumption_component"
    ...
    TAREGECO_CURRENCY = "TARegeco.currency"
    TAREGECO_AREA_NAME = "TARegeco.area_name"
    TAREGECO_AREA = "TARegeco.area"
    TAREGECO_YEAR = "TARegeco.year"
    TAREGECO_LAND_REQUIREMENT_ANALYSIS = "TARegeco.land_requirement_analysis"
    TAREGECO_LAND_DISTRIBUTION_MATRIX = "TARegeco.land_distribution_matrix"
    TAREGECO_LAND_COVER_COMPONENT = "TARegeco.land_cover_component"
    TAREGECO_LAND_REQUIREMENT_COEFFICIENT_MATRIX = "TARegeco.land_requirement_coefficient_matrix"
    ...
    TAREGECO_FINAL_DEMAND_CHANGE_SCENARIO = "TARegeco.final_demand_change_scenario"
    TAREGECO_FINAL_DEMAND_LOOKUP_TABLE = "TARegeco.final_demand_lookup_table"
    TAREGECO_GDP_SCENARIO = "TARegeco.gdp_scenario"
    TAREGECO_GDP_CHANGE_SCENARIO = "TARegeco.gdp_change_scenario"
    ...
    SCIENDO_PROCESS = "SCIENDO.process"
    SCIENDO_BROWSE = "SCIENDO.browse"
    ...
    SCIENDO_PROVIDE_TRAJECTORY_NAME = "SCIENDO.provide_trajectory_name"
    ...
    CONF_LOADED_CONFIGURATION = "Configuration.loaded_configuration"
    ...
    CONF_LOADED_TEMPLATE = "Configuration.loaded_template"
    ...
    MSG_DB_CHOOSE_DATA_TO_BE_DELETED = "Message.db_choose_data_to_be_deleted"
    ...
    MSG_TA_SELECT_DESCRIPTIVE_ANALYSIS_OUTPUT = "Message.ta_select_descriptive_analysis_output"
    MSG_TA_SELECT_PROJECT_FILE = "Message.ta_select_project_file"
    MSG_TA_SELECT_PROFIT_TABLE = "Message.ta_select_profitability_table"
    MSG_TA_SELECT_NPV_TABLE = "Message.ta_select_npv_table"
    MSG_TA_SELECT_OPCOST_DB = "Message.ta_select_opcost_db"
    MSG_TA_SELECT_OPCOST_REPORT = "Message.ta_select_opcost_report"
